            ...
            <div className="flex flex-col">
              ...
              {viagem.detalhes ? (
                ...
                <div className="bg-white p-8 rounded-2xl shadow-lg text-gray-700 flex-1 flex flex-col">
                  {/* Título "Roteiro" adicionado */}
                  <h2 className="text-3xl font-bold text-gray-800 mb-4">
                    Roteiro
                  </h2>
                  {/* Div separada para renderizar o HTML com o estilo 'prose' */}
                  <div
                    className="prose lg:prose-xl max-w-none" // max-w-none remove a limitação de largura do prose
